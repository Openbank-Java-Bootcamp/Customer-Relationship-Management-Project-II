...
//    public void setUp() {
//        testCrm = new CRM();
//        lead1 = new Lead("John Smith", 123456789, "jsmith@example.com", "Company A", sale);
...
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfProduct(testScan1));
//        testScan1.close();
//    }
//
//    @Test
...
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfProduct(testScan1));
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfProduct(testScan2));
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfProduct(testScan3));
//        testScan1.close();
//        testScan2.close();
//        testScan3.close();
//    }
...
//        Scanner testScan1 = new Scanner(new StringReader(" "));
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfIndustry(testScan1));
//        testScan1.close();
//
//    }
//
...
//        Scanner testScan3 = new Scanner(new StringReader("0"));
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfIndustry(testScan1));
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfIndustry(testScan2));
//        assertThrows(NoSuchElementException.class, () -> testCrm.typeOfIndustry(testScan3));
//        testScan1.close();
//        testScan2.close();
//        testScan3.close();
//    }
